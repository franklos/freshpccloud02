...
<body>
  ...
  <main class="container admin-container">
    ...
    <section id="tasks-section" class="content-section">
      ...
      <form id="taskForm" class="task-form">
        <div class="form-row">
          ...
          <div class="form-group">
            <label for="assigned_to">Engineer</label>
          ...
          <div class="form-group">
            <label for="scheduled_date">Gepland (YYYY-MM-DD HH:MM)</label>
            <input id="scheduled_date" name="scheduled_date" placeholder="2025-08-20 10:00:00">
          </div>
        </div>
        <div class="form-group">
    ...
    <section id="clients-section" class="content-section" style="margin-top:2rem; display:none;">
      ...
      <form id="clientForm" class="task-form">
        <div class="form-row">
          <div class="form-group"><label for="cname">Naam</label><input id="cname" name="name" required></div>
          <div class="form-group"><label for="cemail">E-mail</label><input id="cemail" name="email"></div>
          <div class="form-group"><label for="cphone">Telefoon</label><input id="cphone" name="phone"></div>
          <div class="form-group"><label for="cstreet">Straat</label><input id="cstreet" name="address_street"></div>
          <div class="form-group"><label for="cnumber">Huisnr</label><input id="cnumber" name="address_number"></div>
          <div class="form-group"><label for="cpostcode">Postcode</label><input id="cpostcode" name="address_postcode"></div>
          <div class="form-group"><label for="ccity">Plaats</label><input id="ccity" name="address_city"></div>
          <div class="form-group"><label for="ccountry">Land</label><input id="ccountry" name="address_country"></div>
        </div>
        <div class="form-group"><label for="cnotes">Notities</label><textarea id="cnotes" name="notes"></textarea></div>
        <div class="form-buttons">
          <button type="submit" class="btn btn-primary">Klant opslaan</button>
          <span id="clientMsg" class="error"></span>
        </div>
      </form>
    </section>
  </main>
  ...
  <script src="/assets/admin_clean.js" defer></script>
</body>
</html>
